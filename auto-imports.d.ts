...
declare global {
  ...
  const Timeline: typeof import('@mui/lab')['Timeline']
  const TimelineConnector: typeof import('@mui/lab')['TimelineConnector']
  const TimelineContent: typeof import('@mui/lab')['TimelineContent']
  const TimelineDot: typeof import('@mui/lab')['TimelineDot']
  const TimelineItem: typeof import('@mui/lab')['TimelineItem']
  const TimelineOppositeContent: typeof import('@mui/lab')['TimelineOppositeContent']
  const TimelineSeparator: typeof import('@mui/lab')['TimelineSeparator']
